...
```json
{
  ...
  "summary": {
    "call_summary": "Homeowner inquired about solar panel installation. Has a 2000 sq ft home with south-facing roof. Budget of $30k. Timeline: 2-3 months.",
    "key_points": [
      "Customer owns home (not renting)",
      "High electricity bills ($350/month)",
    ...
    "outcome_category": "appointment_booked",
    "next_steps": "Follow-up call scheduled for 2026-01-15"
  },
  "compliance": {
  ...
  "objections": {
    ...
    "objections": [
      ...
      },
      {
        "id": 2,
        "category_id": 7,
        "category_text": "Timeline Concern",
        "objection_text": "How long will installation take?",
        "overcome": false,
        "speaker_id": "home_owner",
        "timestamp": "00:04:12",
  ...
  "qualification": {
    ...
    "appointment_type": "in_home_consultation",
    ...
    "service_address_raw": "123 Main St, San Francisco, CA 94102",
    ...
    "urgency_signals": [
      ...
      "Interested in tax incentives before year end"
    ],
    "budget_indicators": [
      "Budget of $30k available",
      "Interested in financing options"
    ],
    "is_deprioritized": false,
    "service_wait_time_weeks": null,
    "applied_rules": [],
    "pending_actions": [
      {
        "type": "send_proposal",
        ...
        "raw_text": "I'll send you a detailed proposal by tomorrow",
        "confidence": 0.95,
...
- `compliance.target_role`: The role this call was evaluated against
- `qualification.call_outcome_category`: Enhanced outcome (see Call Outcome Categories below)
- `qualification.detected_call_type`: Type of call (fresh_sales, follow_up_inquiry, existing_customer_service)
- `qualification.is_existing_customer`: Boolean indicating if customer has previous interactions
- `qualification.property_details`: Home services specific property information
- `qualification.customer_name`: Customer's name extracted from call
- `qualification.customer_phone`: Customer's phone number
- `qualification.customer_email`: Customer's email address
- `qualification.decision_makers`: List of people with decision authority
- `qualification.service_address_raw`: Full address as mentioned in call
- `qualification.service_address_structured`: Parsed address components
- `qualification.is_deprioritized`: Whether service is deprioritized per tenant rules
- `qualification.service_wait_time_weeks`: Wait time if service is deferred
- `qualification.applied_rules`: Tenant-specific rules that were applied
...
- `appointment_rescheduled`: Existing appointment being rescheduled
- `appointment_cancelled`: Appointment cancellation

**Important - Objections Data Format:**

The `objections` field in the response contains an **array of rich objects** (not strings). Each objection object includes:

- `id`: Objection identifier (nullable)
- `category_id`: Category number (1-10)
- `category_text`: Human-readable category name
- `objection_text`: The actual objection statement from the customer
- `overcome`: Boolean indicating if the objection was resolved
- `speaker_id`: Who raised the objection (e.g., "home_owner", "business_owner")
...
- `response_suggestions`: Array of recommended responses
- `created_at`: Timestamp when objection was processed
  ...
  "objections": [
    {
      ...
      "insight_heading": "Price Remains Top Objection",
      "insight": "Price concerns appeared in 29% of calls. 64% overcome rate shows room for improvement. Top performers consistently address value before price.",
    ...
    {
      "category_id": 7,
      "category_name": "Timeline Concern",
      ...
      "top_responses": [
        ...
        "Offer priority scheduling options"
      ],
      "insight_heading": "Timeline Concerns Well-Handled",
      "insight": "82% overcome rate on timeline objections. Customers respond well to clear timeline communication.",
      "recommendation": "Continue current approach. Consider creating visual timeline infographic for proposals."
    },
    {
      "category_id": 1,
      "category_name": "Need Clarification",
      ...
      "top_responses": [
        ...
        "Calculate current costs vs. future savings",
        "Share relevant case studies"
      ],
      "insight_heading": "Strong Need Identification",
      "insight": "90% overcome rate shows excellent discovery and qualification. Objections decreasing week-over-week.",
...
**Description:** Get aggregated effectiveness metrics for a specific coach.
